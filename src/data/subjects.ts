...
export const SUBJECTS: SubjectMeta[] = [
  ...
  {
    id: 'ap-physics',
    name: 'AP Physics (Algebra-Based)',
    slug: 'ap-physics',
    color: 'indigo',
    units: [
      // AP Physics 1
      { unit: 1,  title: 'Kinematics',                                section: 'AP Physics 1' },
      { unit: 2,  title: 'Force and Translational Dynamics',          section: 'AP Physics 1' },
      { unit: 3,  title: 'Work, Energy, and Power',                   section: 'AP Physics 1' },
      { unit: 4,  title: 'Linear Momentum',                           section: 'AP Physics 1' },
      { unit: 5,  title: 'Torque and Rotational Dynamics',            section: 'AP Physics 1' },
      { unit: 6,  title: 'Energy and Momentum of Rotating Systems',   section: 'AP Physics 1' },
      { unit: 7,  title: 'Oscillations',                              section: 'AP Physics 1' },
      { unit: 8,  title: 'Fluids',                                    section: 'AP Physics 1' },
      // AP Physics 2
      { unit: 9,  title: 'Thermodynamics',                            section: 'AP Physics 2' },
      { unit: 10, title: 'Electric Force, Field, and Potential',      section: 'AP Physics 2' },
      { unit: 11, title: 'Electric Circuits',                         section: 'AP Physics 2' },
      { unit: 12, title: 'Magnetism and Electromagnetism',            section: 'AP Physics 2' },
      { unit: 13, title: 'Geometric Optics',                          section: 'AP Physics 2' },
      { unit: 14, title: 'Waves, Sound, and Physical Optics',         section: 'AP Physics 2' },
      { unit: 15, title: 'Modern Physics',                            section: 'AP Physics 2' },
    ],
  },
  {
    id: 'test-prep',
